...
- Cloudflare account inspection found no domains or subdomains available for a hostname route. The staged named tunnel consequently has zero routes and remains inactive. A durable public origin is the remaining infrastructure blocker for external merchant onboarding. The loopback receipts above do not prove AWS external reachability, a Worker-to-AWS request, or a live Meta delivery, and none is claimed.

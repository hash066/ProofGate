...
- Cloudflare Worker version `f4c3e9f2-f98e-49e4-a6d4-528538eae0e0` serves the current Axcas product plus `/privacy`, `/terms`, and `/data-deletion` with CSP, no-sniff, and explicit cache policy. This is the current deployment superseding the prior version above.

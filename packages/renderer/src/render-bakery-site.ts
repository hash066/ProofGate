...
export function renderBusinessSite(input: SiteSpecV2, version: { versionId: string; specHash: string }): string {
...
<img src="/assets/${encodeURIComponent(item.imageAssetId)}" alt="${escapeHtml(item.name)}" loading="lazy">
